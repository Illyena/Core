...
public class ModdedWorldGen {
    ...
    public static void registerWorldGen( ) {
        ...
        CONFIGURABLE_CONCENTRIC_RINGS = Registry.register(Registry.STRUCTURE_PLACEMENT, "configurable_concentric_rings", () -> ConfigurableConcentricStructurePlacement.CODEC);
    }
