package illyena.gilding.core.particle.custom;
...
public class StarParticle extends SpriteBillboardParticle {
    ...
    protected StarParticle(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
            StarParticle starParticle = new StarParticle(clientWorld, d, e, f, g, h, i);
